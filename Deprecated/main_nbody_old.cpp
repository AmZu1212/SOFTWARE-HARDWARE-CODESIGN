...
{ // mode 0 - serial ; mode 1 - parallel
    ...
    cout << endl
         << ((mode == 0) ? "serial" : "parallel") << " performance" << ": " << "average(ms): " << average << " median(ms):" << median << " rate:" << rate << endl;
    cout << "-----------------------------------------------------" << endl;
    cout << "* - warm-up, not included in average" << endl
         << endl;
...
int main()
{
    ...
    cout << "\nPropagating " << nParticles << " particles using serial implementation on CPU" << endl
         << endl;
    ...
    cout << "\n\nPropagating " << nParticles << " particles using parallel threads on CPU" << endl
         << endl;
